...
topSingleMuonLooseDQM_HLT = cms.EDAnalyzer("TopSingleLeptonTriggerObjectDQM",
  ## ------------------------------------------------------
  ## SETUP
  ##
...
topSingleMuonMediumDQM_HLT = cms.EDAnalyzer("TopSingleLeptonTriggerObjectDQM",
  ## ------------------------------------------------------
  ## SETUP
  ##
  ## configuration of the MonitoringEnsemble(s)
...
topSingleElectronLooseDQM_HLT = cms.EDAnalyzer("TopSingleLeptonTriggerObjectDQM",
  ## ------------------------------------------------------
  ## SETUP
  ##
  ## configuration of the MonitoringEnsemble(s)
...
topSingleElectronMediumDQM_HLT = cms.EDAnalyzer("TopSingleLeptonTriggerObjectDQM",
  ## ------------------------------------------------------
  ## SETUP
  ##
  ## configuration of the MonitoringEnsemble(s)
