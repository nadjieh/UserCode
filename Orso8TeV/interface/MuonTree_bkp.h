...
public :
   ...
   MuonTree(TTree *tree, TFile * f, TString treeName);
   virtual ~MuonTree(){};
   virtual Int_t    Cut(Long64_t entry){return 1;};
   virtual Int_t    GetEntry(Long64_t entry){return 1;};
   virtual Long64_t LoadTree(Long64_t entry){return -100000;};
...
#ifdef MuonTree_cxx
MuonTree::MuonTree(TTree *tree = 0, TFile * f = 0, TString treeName = "") : fChain(0) 
{
