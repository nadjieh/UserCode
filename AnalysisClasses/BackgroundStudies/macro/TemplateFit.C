...
int main(int argc, char** argv) {
    ...
    for (int f = 1; f < argc; f++) {
        ...
        if (arg_fth == "signal") {
            ...
            Signal1D.push_back((TH1*)file->Get("Default/DefaultcosTheta"));
            Signal2D.push_back((TH2*)file->Get("Default/DefaultcosTheta2D"));
...
//            bkg = ((TH1*)file->Get("RandomB/RandomBcosTheta"));
//            bkg = ((TH1*)file->Get("Default/DefaultcosTheta"));
            nont = ((TH1*)file->Get("Default/DefaultcosTheta"));
        }
    }
    TH1* signal;
    stringstream n;
