...
using namespace std;
int main(){
    TFile * F = new TFile("/home/ajafari/rootfiles/TopTrees/7TeV/July10/Skimmed/GenSignal.root","read");
...
//    myElecCuts.Id = "NoId"; myElecCuts.IdSecond = "NoId";
//    myElecCuts.IsoType = "";
//    myElecCuts.D0 = 200.;
//    myElecCuts.IsoCut = 1100;
//
    ElectronCuts myElecCuts;
    myElecCuts.Pt = 30;
    myElecCuts.eta = 2.4; myElecCuts.ExLow = 1.442; myElecCuts.ExHigh = 1.56;
    ...
    myJetCuts.nCaloTower = -1;
    myJetCuts.EmfUp = 100.; myJetCuts.EmfLow = -10;
    myJetCuts.fhpd = 1000.; myJetCuts.N90 = -1;
    myJetCuts.bTagCut = -200.;
...
//    DataAnalysis * myDataAnalysis = new DataAnalysis("FdataDATA",60., 160.,160.,280.);
    ...
    AnalysisHandler Signalanalysis("GenStudy_JetMtahed_RelaxedJet",/*dobtag*/false,/*doBtagDataLike*/false,/*extJetOk_*/true,/*Lumi*/100.,
    myMassResolution,myElecCuts,myJetCuts,/*whichMethod*/"minChi2",/*Ott*/false,/*rrE*/false,/*matchEle*/false);
...
//        cout<<"--------------------------------------runId : "<<pracEvt.Event()->runId()<<endl;
//        cout<<"--------------------------------------eventId : "<<pracEvt.Event()->eventId()<<endl;
