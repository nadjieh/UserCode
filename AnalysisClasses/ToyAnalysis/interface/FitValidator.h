...
public:
    ...
    SamplesInfo() {
        ...
        //        Xsections["tWHadMu"] = 0.58; //2
        //        Xsections["tWbarHadMu"] = 0.58; //3
        //        Xsections["tWEMu"] = 0.097; //2
        //        Xsections["tWbarEMu"] = 0.097; //3
        //        Xsections["tWTauMu"] = 0.097; //2
        //        Xsections["tWbarTauMu"] = 0.097; //3
        //        Xsections["tWRest"] = 7.3; //2
        //        Xsections["tWbarRest"] = 7.3; //3
